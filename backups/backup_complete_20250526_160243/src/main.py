    ...
    <body>
        <div class="container">
            <header>
                ...
                <div class="subtitle">{api_info_data['description']}</div>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <ul class="feature-list">
                            {''.join(f'<li>{feature}</li>' for feature in api_info_data['features']['core'][:5])}
                        </ul>
                        <p><a href="/docs" class="link-button">Ver todas las características</a></p>
                    </div>
                </div>
            </div>
